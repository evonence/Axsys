...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //RecordViewController *mainViewController = [[RecordViewController alloc] init];
    //mainViewController.recorder.session = newRecordSession;
    
    //RecordController
    
    //RecordViewController *mainViewController = [[RecordViewController alloc] init];
    //mainViewController.recorder.session = _recorder.session;
